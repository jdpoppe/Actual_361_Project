...
from school_app.views import Login, Dashboard, CreateCourse, CreateSection, AssignInstructor, InstructorAssignTA, Notifications, Account, CreateAccount, ClassView

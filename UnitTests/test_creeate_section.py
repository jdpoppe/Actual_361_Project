...
class createSection(unittest.TestCase):
    def setUp(self):
        self.instructor = Employee.objects.create(Email_Field="jimgaffigan@uwm.edu", EMP_FNAME="Jim",
                                                  ...
                                                  EMP_PASSWORD="123")
        self.ta = Employee.objects.create(Email_Field="bertkreischer@uwm.edu", EMP_FNAME="Bert",
        ...
        self.section = Section.objects.create(title="Lab 801", course="Comedy 251", ta="bertkreischer@uwm.edu")

    def test_noTitle(self):
        self.assertEqual("Section needs title", createSection("", "bertkreischer@uwm.edu", "Comedy 251"),
                         msg="Entering a section with no title fails to return message, \"Section needs title\"")

    def test_noCourse(self):
        self.assertEqual("Must enter course", createSection("Lab 802", "bertkreischer@uwm.edu", ""),
                         msg="Entering a section with no parent course fails to return message, \"Must enter course\"")

    def test_courseDNE(self):
        self.assertEqual("Course does not exists", createSection("Lab 802", "bertkreischer@uwm.edu", "Comedy 361"),
    ...
    def test_validInput(self):
        self.assertEqual("Section successfully created",
                         createSection("Lab 802", "bertkreischer@uwm.edu", "Comedy 251"),
